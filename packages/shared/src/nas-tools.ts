...

  {
    ...
    buildCommand: (input) => {
      ...
      return [
        ...
        "scheduler_roots='/host/usr/syno/etc /host/usr/syno/etc/schedule /host/usr/syno/etc/synotask /host/etc /host/etc/synotask /host/var/services /host/var/packages'",
        "dbs=$(",
...

  {
    ...
    buildCommand: (input) => {
      ...
      return [
        ...
        "snapshot_roots='/host/usr/syno/etc /host/usr/syno/etc/packages /host/etc /host/var/packages/SnapshotReplication /host/var/packages/ReplicationService /var/packages/SnapshotReplication /var/packages/ReplicationService /volume1/@appdata/SnapshotReplication /volume2/@appdata/SnapshotReplication /volume1/@appdata/ReplicationService /volume2/@appdata/ReplicationService /volume1/@database/SnapshotReplication /volume2/@database/SnapshotReplication /volume1/@database/ReplicationService /volume2/@database/ReplicationService /volume1/@appconf/SnapshotReplication /volume2/@appconf/SnapshotReplication /volume1/@appconf/ReplicationService /volume2/@appconf/ReplicationService /volume1/@appstore/SnapshotReplication /volume2/@appstore/SnapshotReplication /volume1/@appstore/ReplicationService /volume2/@appstore/ReplicationService'",
        "echo 'Roots present:'",
